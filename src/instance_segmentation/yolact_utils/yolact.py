...
from src.instance_segmentation.yolact_utils.backbone import construct_backbone
from src.instance_segmentation.yolact_utils.data.config import cfg, mask_type
from src.instance_segmentation.yolact_utils.layers.functions.detection import Detect
from src.instance_segmentation.yolact_utils.utils import timer
from src.instance_segmentation.yolact_utils.utils.functions import MovingAverage, make_net
...
if __name__ == '__main__':
    ...
    import sys
    if len(sys.argv) > 1:
        from src.instance_segmentation.yolact_utils.data import set_cfg
        set_cfg(sys.argv[1])
